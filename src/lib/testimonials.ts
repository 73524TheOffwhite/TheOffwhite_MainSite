...
import {
  ELFSIGHT_GOOGLE_REVIEWS_WIDGET_ID,
  fetchElfsightGoogleReviews,
} from "@/lib/elfsight-google-reviews";
...
export function useTestimonials() {
  const testimonialsQuery = useQuery({
    queryKey: ["testimonials", "home", "elfsight-google-reviews", "all", ELFSIGHT_GOOGLE_REVIEWS_WIDGET_ID],
